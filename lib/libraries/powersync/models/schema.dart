...
const schema = Schema([
  ...
  Table(
    ...
    indexes: [
      Index('by_credential', [IndexedColumn('credential_id')]),
    ],
  ),

  /// IMPORTANT: Ensure sync-streams.yaml includes owning_company_id,
  /// export_folder_link, and export_storage_provider in the SELECT for
  /// user_projects, otherwise these columns will always be NULL.
  Table(
    'projects',
    [
