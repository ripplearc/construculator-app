...
class FavoriteEstimationCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final dateTimeText = dateFormatter.format(estimation.date).toLowerCase();

    final costFormatter = NumberFormat.currency(symbol: '\$');
    final costText = costFormatter.format(estimation.totalCost);
