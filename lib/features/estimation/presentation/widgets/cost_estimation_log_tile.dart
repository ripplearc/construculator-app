...
class CostEstimationLogTile extends StatelessWidget {
  ...
  Widget _buildSubtitle(BuildContext context) {
    switch (log.activity) {
      ...
      case CostEstimationActivityType.taskUnassigned:
        return _buildTaskUnassignedSubtitle(context);
      default:
  ...
  Widget _buildTaskUnassignedSubtitle(BuildContext context) {
    final taskName = log.activityDetails['taskName'] as String?;
    if (taskName != null) {
      return _buildSubtitleSingleInfo(context, 'Task: ', taskName);
    }
    return const SizedBox.shrink();
  }
