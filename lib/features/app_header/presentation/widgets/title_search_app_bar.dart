...
class TitleSearchAppBar extends StatelessWidget implements PreferredSizeWidget {
  ...
  // The content box the actions are laid out in. [CoreAppBar] adds [_padding]
  // around this rather than subtracting it from it, so the search icon keeps a
  // full 48x48 tap target even with vertical padding applied (CA-822).
