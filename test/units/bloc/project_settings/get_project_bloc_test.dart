...
import 'package:construculator/features/project/testing/project_test_module.dart';
...
void main() {
  ...
  group('GetProjectBloc Tests', () {
    ...
    setUp(() {
      Modular.init(ProjectTestModule());
    ...
    group('GetProjectByIdLoadRequested', () {
      ...
      blocTest<GetProjectBloc, GetProjectState>(
        ...
        build: () {
          // Don't add any project to the repository
          return bloc;
        },
        act: (bloc) =>
      ...
      blocTest<GetProjectBloc, GetProjectState>(
        ...
        build: () {
          final minimalProject = createTestProject(); // Uses all defaults
