...
void main() {
  ...
  group('ConsentGuard', () {
    ...
    test('admits a user whose check failed but who accepted previously', () async {
    ...
    test('blocks a user whose accepted version is superseded', () async {
      repository.cachedStatusToReturn = ConsentOutdated(acceptedVersion: 1, requiredVersion: publishedVersion);
