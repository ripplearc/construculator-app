...
void main() {
  ...
  group('Log filtering by environment', () {
    test('prod mode suppresses debug and info in console', () {
      ...
      expect(fakeSentry.breadcrumbs[0].level, SentryEventLevel.info);
      expect(fakeSentry.breadcrumbs[1].level, SentryEventLevel.warning);
    });
    ...
    test('qa mode suppresses debug in console', () {
      ...
      expect(fakeSentry.breadcrumbs.length, 1);
      expect(fakeSentry.breadcrumbs.first.level, SentryEventLevel.info);
    });
