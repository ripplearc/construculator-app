...
void main() {
  ...
  Future<void> pumpRetryErrorState(
    WidgetTester tester, {
  ...
  group('CostEstimationLogsList accessibility', () {
    ...
    testWidgets(
      ...
      (tester) async {
        ...
        await setupA11yTest(tester);
        await pumpRetryErrorState(tester, theme: createTestTheme());

        await expectMeetsTapTargetAndLabelGuidelines(
          tester,
          find.text(l10n().retryButton),
        );
      },
    );
    ...
    testWidgets(
      ...
      (tester) async {
        ...
        await setupA11yTest(tester);
        await pumpRetryErrorState(tester, theme: createTestThemeDark());
