...
4. **Determine test types**
   ...
   - Mutation tests: if 4+ conditional branches (per Mutation Testing: `.claude/rules/13-mutation-testing.md`)
...
- Next skill: `.claude/skills/plan-implementation/SKILL.md`
