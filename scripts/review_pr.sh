...
echo "- ✅ **Logical focus order:** Focus traversal should follow the visual reading order and not trap users; verify with \`WidgetTester\` focus expectations where relevant." >> "$OUTPUT_FILE"
